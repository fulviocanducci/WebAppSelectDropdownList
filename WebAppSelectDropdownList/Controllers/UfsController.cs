...
namespace WebAppSelectDropdownList.Controllers
{
    public class UfsController : Controller
    {
        ...
        public UfsController(DatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Initials")] Uf uf)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var uf = await _context.Uf.SingleOrDefaultAsync(m => m.Id == id);
            if (uf == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Initials")] Uf uf)
        {
            if (id != uf.Id)
            {
                return NotFound();
